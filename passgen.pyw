...
<p><b>Ctrl+1 ... <font color="#ff0000">Simple:</font></b> For typing by hand.</p>
<p><b>Ctrl+2 ... <font color="#ffe900">Medium:</font></b> Contain chars, CHARS, numbers. Excluded similar by writting i, l, o, I, L, O, 1, 0.</p>
<p><b>Ctrl+3 ... <font color="#00bd00">Strong:</font></b> Contain chars, CHARS, numbers, symbols. Excluded similar by writting i, l, o, I, L, O, 1, 0.</p>
<hr />
<p><i>Other keys:</i></p>
<p><b>Ctrl+I ... About me:</b> Show little infromation about me.</p>
<p><b>Ctrl+H ... Help:</b> This window.</p>
<p><b>Ctrl+Q ... Quit:</b> Exit from application.</p>
'''
...
class MainWindow(QtGui.QMainWindow):
	def __init__(self, parent=None):
		...
		new_menu1 = QtGui.QAction(QtGui.QIcon(m_ico), 'Refresh simple password', self)
		new_menu1.setShortcut(SIMPLE_SHORTCUT)
		self.connect(new_menu1, QtCore.SIGNAL('triggered()'), self.get_passwd_simple)
		m_ico = QtGui.QPixmap()
		...
		new_menu2 = QtGui.QAction(QtGui.QIcon(m_ico), 'Refresh medium password', self)
		new_menu2.setShortcut(MEDIUM_SHORTCUT)
		self.connect(new_menu2, QtCore.SIGNAL('triggered()'), self.get_passwd_medium)
		m_ico = QtGui.QPixmap()
		m_ico.loadFromData(base64.b64decode(refresh_icon))
		...
		new_menu3 = QtGui.QAction(QtGui.QIcon(m_ico), 'Refresh strong password', self)
		new_menu3.setShortcut(STRONG_SHORTCUT)
		self.connect(new_menu3, QtCore.SIGNAL('triggered()'), self.get_passwd_strong)
		m_ico = QtGui.QPixmap()
		m_ico.loadFromData(base64.b64decode(refresh_icon))
